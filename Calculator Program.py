...
#Create an entry widget (input field) to be placed in this frae
...
btn_clearing.grid(row=0, columnspan=3, padx=1, pady=1)
#Create a button for the division operator called btn_div
btn_div=tk.Button(btns_frame, text="/", fg="black", width=10, height=2, bd=0, bg="#eee",
...
tk.Button(btns_frame, text="*", fg="black", width=10, height=1, bd=0, bg="#fff",
          cursor="hand2", command=lambda: btn_click("*")).grid(row=1, column=3, padx=1, pady=1)


# Third row of the bottomw frame includes 4 buttons, '4', '5', '6' and 'Subtract (-)':
